...
export const works: Work[] = [
  ...
  {
    id: 7,
    title: 'GuildGrad - Language Edtech',
    date: 'July 2026',
    ...
    category: 'Full-Stack',
    detailedDescription: "GuildGrad is more than a platform — it's a living, breathing community of learners who believe that language grows through connection. It's goal is to build the environment in which everyone thrives by default",
    liveUrl: "https://guildgrad.com",
    features: [
      'Lessons with exercises',
      'Lesson completion and day streak tracking',
      'RBAC model with three user tiers',
      'Integrated MoR (Paddle) to get paid for the services',
      'Authentication handled by Clerk 3rd party',
      'Unique logo and navbar animation',
      'Community features: voting and proposals',
      'Responsive ui (mobile and desktop)'
    ],
    challenges: [
      'Building basic notification system',
      'Logo animation and navbar behavior',
      'Applying SSR components where possible',
      'Designing database architecture',
      'Implementing role-based access control system synced with Paddle',
      'Clerk merchant of records proper setup',
      'SSL, DNS and deployment configuration'
    ],
